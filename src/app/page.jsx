  ...
  return (
    <div className='bg-white px-[15px]'>
      ...
      <section className="min-h-screen pt-[80px] " id="servicios">
        <h2 className="w-full text-[20px] text-center font-bold">SWOOU servicios</h2>
        <div className="flex justify-center flex-wrap md:grid grid-cols-3 gap-[30px]">
          <Card img='/web.svg'
            ...
            <h4 className='text-center font-bold'>DISEÑO Y DESARROLLO WEB y APK</h4>
          ...
          <Card img='/host.svg'
            ...
            <h4 className='text-center font-bold'>DOMINIOS Y HOSTINGS</h4>
            <p className={style.paragraphLeft}>
              <b>Dominios</b><br />
              NameCheep<br />
              Google Domain<br />
          ...
          <Card img='/search.svg'
            ...
            textButtonOne={'Cotizar'}
            textButtonTwo={'Consultar'}>
            <h4 className='text-center font-bold'>POSICIONAMIENTO SEO</h4>
            <p className={style.paragraphLeft}>
              <b>Navegadores</b><br />
              Google<br />
              Bing<br />
      ...
      <section className="min-h-screen pt-[80px]" id="productos">
        <h2 className="w-full text-[20px] text-center font-bold pb-[30px]">Prueba Los Productos SWOOU</h2>
        <div className="flex justify-center flex-wrap md:grid grid-cols-3 gap-[30px]">
          <Card img='/mathLogo.svg'
            ...
            <p>Aplicación web y android instalable con
      ...
      <section className="min-h-screen pt-[80px]" id="nosotros">
        <h2 className="w-full text-[20px] text-center font-bold pb-[30px]">ACERCA DE</h2>
